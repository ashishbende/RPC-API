...
public class RouteGuideGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.examples.routeguide.Point,
      ...
      io.grpc.stub.Method.create(
          ...
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.Point.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.Feature.PARSER));
  private static final io.grpc.stub.Method<io.grpc.examples.routeguide.Rectangle,
      ...
      io.grpc.stub.Method.create(
          ...
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.Rectangle.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.Feature.PARSER));
  private static final io.grpc.stub.Method<io.grpc.examples.routeguide.Point,
      ...
      io.grpc.stub.Method.create(
          ...
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.Point.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.RouteSummary.PARSER));
  private static final io.grpc.stub.Method<io.grpc.examples.routeguide.RouteNote,
      ...
      io.grpc.stub.Method.create(
          ...
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.RouteNote.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.routeguide.RouteNote.PARSER));
  ...
  public static class RouteGuideServiceDescriptor extends
    ...
    private RouteGuideServiceDescriptor() {
      getFeature = createMethodDescriptor(
          "grpc.example.routeguide.RouteGuide", METHOD_GET_FEATURE);
      listFeatures = createMethodDescriptor(
          "grpc.example.routeguide.RouteGuide", METHOD_LIST_FEATURES);
      recordRoute = createMethodDescriptor(
          "grpc.example.routeguide.RouteGuide", METHOD_RECORD_ROUTE);
      routeChat = createMethodDescriptor(
          "grpc.example.routeguide.RouteGuide", METHOD_ROUTE_CHAT);
    }
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder("grpc.example.routeguide.RouteGuide")
