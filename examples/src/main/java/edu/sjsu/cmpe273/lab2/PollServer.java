...
public class PollServer {
    ...
    private class PollServiceImpl implements PollServiceGrpc.PollService{
        ...
        public void createPoll(PollRequest req, StreamObserver<PollResponse> responseObserver){
            ...
            final AtomicInteger counter = new AtomicInteger(9834567);
            String poll_id = Integer.toHexString(counter.getAndIncrement());
            System.out.println("Received Poll request from Moderator Id: " +req.getModeratorId());
            System.out.println("Poll Content: ");
            System.out.println("Question: " +req.getQuestion());
            System.out.println("Started At: " + req.getStartedAt());
            System.out.println("Expired At: " + req.getExpiredAt());
            System.out.println("Choice: " + req.getChoice(0)+", "+ req.getChoice(1));
